...
var startListeningEpic = function (action$, store) {
    return action$.ofType('Listening_Starting')
        ...
        var locale, onIntermediateResult, onFinalResult, onAudioStreamStart, onRecognitionFailed;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    locale = store.getState().format.locale;
                    ...
                    return [4 /*yield*/, SpeechModule_1.Speech.SpeechRecognizer.startRecognizing(locale, onIntermediateResult, onFinalResult, onAudioStreamStart, onRecognitionFailed)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
